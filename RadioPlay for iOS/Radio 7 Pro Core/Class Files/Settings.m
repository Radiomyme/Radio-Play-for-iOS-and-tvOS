...
BOOL *const GOOGLE_BANNER_Rectangle = YES; //Will hide the Album Art and display an ad.
BOOL *const GOOGLE_BANNER_HOME= YES; //Add a banner in the HomeView at the bottom
