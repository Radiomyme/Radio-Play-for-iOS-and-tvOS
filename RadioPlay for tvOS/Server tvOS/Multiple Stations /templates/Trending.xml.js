...
<document>
  ...
  <descriptiveAlertTemplate class="templateBackground" theme="dark">
    ...
    <shelf>
        <section>
        <lockup Id="Radiomyme">
    	<img src="http://data.radiomyme.com/TVOS/tv/resources/images/radio/Radiomyme.jpg" width="308" height="308" />
        ...
        <lockup Id="ClubOne">
        <img src="http://data.radiomyme.com/TVOS/tv/resources/images/radio/Club1.jpg" width="308" height="308" />
